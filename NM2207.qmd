...
Her songs are on the average danceability and energy side, with means of 0.598 and 0.577 respectively. However, her songs are generally quite fast and upbeat with a tempo of 125BPM. Perhaps the fast tempo of her songs contribute to their "catchiness", increasing their popularity throughout the world!

Nevertheless, there seems to be no clear trend for danceability, energy and tempo as time passes.
...
Ironically, a lot of her songs are not acoustic either, despite her reputation as an indie musician. Although she does have a few acoustic versions of her songs, she has many songs that score low in the acoustic department, with a mean acousticness score of 0.300. Maybe her use of electric and digital instruments in appropriate scenarios could be what sets her apart from other singer-songwriters. Taylor Swift also did not have many live recorded tracks, showing how most of her tracks are meticulously prerecorded, with a mean liveness score of 0.141.
...
-   Taylor's top 3 favourite keys are: G Major (n=50), C Major (n=41), F Major (n=30). Goes to show that simpler keys with less accidentals can be beneficial to her music popularity!

-   She had 11 songs with no clear key.

-   She had 239 songs in major keys, but only 24 songs in minor key. The major key usually sounds happier than the minor key, which may be a common trait that makes Taylor Swift's music so endearing.
...
That being said, for those who want to follow in Taylor Swift's footsteps, there are a few things that you can do. Start by making more melodies within your music and less speech, use more electronic instruments rather than acoustic ones, use more major key instead of minor key, and keep honing your vocal skills to make more use of them rather than instrumentation!
